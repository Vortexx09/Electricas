-- Muestra un resumen legible de los alquileres, incluyendo información del usuario, patineta y tarifa.
...
-- Muestra la última ubicación registrada de cada patineta 
